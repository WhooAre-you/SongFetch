...
function extractSeriesCoreName(title) {
  ...
  // 1. Standalone Arabic Ordinal Words to remove
  const ordinals = [
    'الاولى', 'الاول', 'الثانيه', 'الثاني', 'الثالثه', 'الثالث', 'الرابعه', 'الرابع',
    'الخامسه', 'الخامس', 'السادسه', 'السادس', 'السابعه', 'السابع', 'الثامنه', 'الثامن',
    'التاسعه', 'التاسع', 'العاشره', 'العاشر', 'الحاديه عشر', 'الثانيه عشر', 'الثالثه عشر',
    'الرابعه عشر', 'الخامسه عشر', 'السادسه عشر', 'السابعه عشر', 'الثامنه عشر', 'التاسعه عشر',
    'العشرون', 'الحاديه والعشرون', 'الثانيه والعشرون', 'الثالثه والعشرون', 'الرابعه والعشرون',
    'الخامسه والعشرون', 'السادسه والعشرون', 'السابعه والعشرون', 'الثامنه والعشرون',
    'التاسعه والعشرون', 'الثلاثون'
  ];

  for (const ord of ordinals) {
    cleaned = cleaned.replace(new RegExp(`\\b${ord}\\b`, 'gi'), '');
  }

  // 2. Remove episode & season keywords and any isolated numbers
  cleaned = cleaned
    .replace(/الحلقه/gi, '')
    .replace(/حلقه/gi, '')
    .replace(/episode/gi, '')
